/**
 * @file planner.hpp
 * @brief auxiliary class to run the tests
 */
...
/**
 * @brief contains some auxiliary functions to run the tests
 */
class Planner{
    protected:
    ...
    public:
        ...
        multi_dubins::path_t dps(const VisiLibity::Polyline&, double&, double&);
};
